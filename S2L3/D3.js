...
for ( i = 0; i < starWarsCharacters.length; i++) {
  switch (starWarsCharacters[i].eye_color) {
      case "blue":
          blueEyes.push(starWarsCharacters[i]);
          break;
      case "yellow":
          yellowEyes.push(starWarsCharacters[i]);
          break;
      case "brown":
          brownEyes.push(starWarsCharacters[i]);
          break;
      case "red":
           redEyes.push(starWarsCharacters[i]);
      case "blue_gray":
          blue_grayEyes.push(starWarsCharacters[i]);
  }
}

console.log("Blue Eyes:", blueEyes);
console.log("Yellow Eyes:", yellowEyes);
console.log("Brown Eyes:", brownEyes);
console.log("Red Eyes:", redEyes);
console.log("Blue_gray Eyes:", blu_grayEyes);
...
switch (crewMass) {
  case <= 500 : console.log("Ship is under loaded");
  case > 500 && <700 : console.log("Ship is half loaded");
  case >= 700 && < 900 : console.log("Warning: Load is over 700");
  case >= 900 && < 1000 : console.log("Critical Load: Over 900");
  case >= 1000 : console.log("DANGER! OVERLOAD ALERT: escape from ship now!");
}
